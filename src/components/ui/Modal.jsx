    ...
    >
      <div className={`modal-box ${sizeClasses[size] || ''}`}>
        <div className='flex justify-between items-center mb-4 border-b border-base-200 pb-3'>
          ...
          <Button onClick={onClose} variant='destructive' size='icon' className='h-8 w-8' aria-label="Close modal" title="Close modal">
      ...
      <form method='dialog' className='modal-backdrop'>
        <button tabIndex={-1} aria-label='Close modal' onClick={onClose}>close</button>
      </form>
    </dialog>
  );
};
