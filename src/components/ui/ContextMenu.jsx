...
import { Edit, RefreshCw, Trash2, ScreenShare, History, Power, Play } from "lucide-react";
  ...
  return (
    ...
    >
      <ul>
        ...
        <li><Button onClick={() => { actions.reset(targetClient); onClose(); }} variant="ghost" className="w-full justify-start px-3 py-1.5 text-sm text-blue-600 dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-900/50" icon={History}>Reset Client</Button></li>
        ...
        <li><Button onClick={() => { actions.shutdown(targetClient); onClose(); }} variant="ghost" className="w-full justify-start px-3 py-1.5 text-sm" icon={Power}>Shutdown</Button></li>
        <li><Button onClick={() => { actions.wake(targetClient); onClose(); }} variant="ghost" className="w-full justify-start px-3 py-1.5 text-sm" icon={Play}>Wake Up</Button></li>
