  ...
  return (
    ...
    >
      <ul className="menu rounded-box w-52">
        <li><a onClick={() => { actions.wake(targetClient); onClose(); }}><Play className="w-4 h-4" />Power On</a></li>
        ...
        {targetClient?.keep_writeback === false && (
          <li><a onClick={() => { actions.resetToClean(targetClient); onClose(); }}><RefreshCw className="w-4 h-4" />Reset to Clean</a></li>
        )}
